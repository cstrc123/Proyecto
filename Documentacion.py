...
signos = ["\u2660", "\u2764", "\u2663", "\u2666"]
#Estas son listas que almacenan los datos de la baraja con su respectivo símbolo
#Se guarda la lista, una baraja la cual contiene 48 caracteres, te despliega corazón, diamante, espada etc.
...
def repartir():
    ...
    suma3 = 0
    suma4 = 0
#Estas unidades en 0's son para los acumulados
    continua = True
#Lo siguiente serían funciones
    while continua:
        letra = "I"
        while letra == "I":
#Los random van a escoger de las listas para soltar una carta aleatoria
            ...
            vs1 = signos[p1c]
            vs2 = signos[p2c]
            if ((v1 == "J" or v1 == "Q" or v1 == "K" or v1 == "A") and (v2 == "J" or v2 == "Q" or v2 == "K" or v2 == "A")): 
#Declara valores
#Son filtros, es decir, si las 2 son letras les asignará valores
                valor2 = 11
                valor1 = 11
...
#Aquí se define por si el jugador teclea la letra N/n
#Esto quiere decir que el jugador ya no desea agarrar más cartas
                suma = suma11 + suma12 + suma13 + suma14
                continua = False
                print("Aquí están sus cartas: ", (combina1,combina2)) 
#Imprime el puntuaje y las cartas 
...
#Este define si el jugador tecleó S/s
#Quiere decir que el jugador desea seguir tomando cartas
                ...
                if v3 == "J" or v3 == "Q" or v3 == "K" or v3 == "A":
                    ...
                    letra=str(input("¿Desea tomar otra carta? S/N: "))
            if letra == "N" or letra == "n": 
#Define si el jugador quiere dejar de tomar cartas
                suma5 = suma3 + suma4
                continua = False
                print("Aquí están sus cartas: ", (combina1,combina2,combina3))
                print("Puntuación: ", suma5)
                print()
#Los 'if' de abajo definen si el usuario ganó o si se acercó al puntaje o si perdió la partida
                if suma5 == 21:
